...
test('skips blocker generation for floor-like meshes', () => {
...
test('skips blocker generation for stair-like meshes by name', () => {
  const parts = buildBlockerSubdivisions(
...
test('skips blocker for stair body by geometry (moderate height + walkable footprint)', () => {
